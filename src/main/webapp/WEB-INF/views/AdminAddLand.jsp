...
<script type="text/javascript">
    ...
    var objUsernameLogin = document.getElementById('i-username');
    var objUpdateAddress = document.getElementById('i-btn-update-address');
    var objAlertUsername = document.getElementById('i-alert-username');
    var objAlertUsernameContent = document.getElementById('i-alert-username-content');
    var objHolderAddress = document.getElementById('i-seller-address');
    var objBtnAddingLand = document.getElementById('i-btn-adding');
    var objInputPrice = document.getElementById('i-price');
    var objSelectStreet = document.getElementById('i-select-street');
    var objSelectWard = document.getElementById('i-select-ward');
    var objSelectDistrict = document.getElementById('i-select-district');
    var objAlertFullfill = document.getElementById('i-alert-fullfill');
    var objInputUploadImage = document.getElementById('i-img-file');
    var objAlertUploadImg = document.getElementById('i-alert-upload-img');
    var objTextAreaDescription = document.getElementById('i-desc');
    var objHashImg = document.getElementById('i-hash-img');
    var objChooseImge = document.getElementById('i-choose-image');
    var objStreetUploaded = document.getElementById('i-street-uploaded');
    var objDescUploaded = document.getElementById('i-desc-uploaded');
    var objWardUploaded = document.getElementById('i-ward-uploaded');
    var objDistrictUploaded = document.getElementById('i-district-uploaded');
    var objImgUploaded = document.getElementById('i-img-uploaded');
    var objPriceUploaded = document.getElementById('i-price-uploaded');
    var objShowPopStatusUploadLand = document.getElementById('i-view-detail');
    var objUpdatingLand = document.getElementById('i-updating-land');
