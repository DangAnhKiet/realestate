...
<div class="sticky-top">
    <ul class="nav-home-admin">
        ...
        <li><a class="nav-hover" id="i-admin-home" href="/admin/home">Quản lí đất</a></li>
        <li><a class="nav-hover" id="i-admin-account" href="/admin/accounts">Quản lí tài khoản</a></li>
